...
SNIPROXY_GENERAL__PREFERRED_VERSION=ipv4only SNIPROXY_GENERAL__BIND_HTTP=127.0.0.1:65535 sniproxy --config /etc/sniproxy/config.yaml > "$TMP/sniproxy.log" 2>&1 & PID=$!; sleep 2
